...
/* NVIDIA note. Three changes were made to this file:
   1) Added include for GL/glext.h
   2) Added void to the declaration of _GLfuncptr, to make
      it a prototype.  (This generates warnings otherwise.)
   3) Added this comment.

   No other changes should be made to this file.  The file as
   delivered from SGI is definitive, and we need to stay as close
   to their version so that we can update to future versions more
   easily.
*/
