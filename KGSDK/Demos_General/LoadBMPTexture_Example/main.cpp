//=======================================================================
//LoadBMPTexture_Example
//--------------------------------------------
//File:			main.cpp
//Description:	An example program, which loads a Bitmap file, creates a
...
GLuint texture[1];	
char *BMPFilenames[] =	//An array, holding filenames of BMP to load
{
	"King.bmp",
};
...
void Init()
{
	if (!LoadTexturesBMP(1, texture, BMPFilenames))		//Load Textures, if fails 
	{
