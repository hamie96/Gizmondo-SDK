//=======================================================================
//Tutorial 4: Textures & Lighting
//--------------------------------------------
//File:			main.cpp
//Description:	Tutorial on how to map textures, and create lighting, to
...
bool ColourMaterial = false;	//Colour Material Enabled?
//--------------------------------------------------------------------------------------------------------------------------------------
...
void Init()
{
	...
	if (!LoadTextures())		//Load Textures, if fails 
	{
...
void Update()
{
	...
	if (Framework_IsButtonPressed(FRAMEWORK_BUTTON_FORWARD	 )) 
	{
		...
		(ColourMaterial ? glEnable(GL_COLOR_MATERIAL) : glDisable(GL_COLOR_MATERIAL));
	}
	// If the Forward button has been pressed: Toggle Colour Material 
}
