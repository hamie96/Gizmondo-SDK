...
//Description:	Contains the BitmappedText Class, and 
//				all its Function Implementations
//
//Author: King (King@Gizmondoforums.com)
//Copyright (c) GizzedINC. All rights reserved.
//=======================================================================

class BitmappedText						//The Bitmapped Font Text Class Implementation..
{
	public:
		BitmappedText(char String[]);	//Constructor
		DrawBitmappedText();			//Function to draw character to screen
...
BitmappedText::BitmappedText(char String[])
{	
...
BitmappedText::DrawBitmappedText()
{
	glPushMatrix();
	...
	for (i = 0; i < NumberOfCharacters; i ++)	//Loop through each character of the text..
	{
		...
		glBindTexture(GL_TEXTURE_2D, texture[FontName]);	//Select Font..
