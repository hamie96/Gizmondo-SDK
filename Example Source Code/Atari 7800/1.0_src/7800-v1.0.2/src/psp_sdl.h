...
# define PSP_SDL_SCREEN_HEIGHT   240
  ...
  extern void psp_sdl_put_char(int x, int y, int color, int bgcolor, char c, int drawfg, int drawbg);
  ...
  extern unsigned short psp_sdl_rgb(uchar R, uchar G, uchar B);
  extern void psp_sdl_save_screenshot(unsigned char const * buffer, unsigned char * palette);
