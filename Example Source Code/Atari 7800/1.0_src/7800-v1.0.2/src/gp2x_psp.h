...
# define GP2X_CTRL_STOP   0x00010
# define GP2X_CTRL_FFWD     0x00020
# define GP2X_CTRL_RWND      0x00040
# define GP2X_CTRL_PLAY     0x00080

# define GP2X_CTRL_LTRIGGER   0x00100
# define GP2X_CTRL_RTRIGGER   0x00200

# define GP2X_CTRL_HOME     0x00400
# define GP2X_CTRL_STAR      0x00800
# define GP2X_CTRL_TRI       0x01000
# define GP2X_CTRL_POWER       0x02000

# define GP2X_CTRL_VOL      0x04000

# define GP2X_CTRL_VOLDOWN  (GP2X_CTRL_VOL|GP2X_CTRL_DOWN)
# define GP2X_CTRL_VOLUP  (GP2X_CTRL_VOL|GP2X_CTRL_UP)
