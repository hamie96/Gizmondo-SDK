...
// so we can run on Win 3.1, where there isn't necessarily Winsock)
    ...
    hInst = LoadLibrary(_T("wsock32.dll"));
    ...
    pWSAStartup = (void *)GetProcAddress(hInst, _T("WSAStartup"));
    pWSACleanup = (void *)GetProcAddress(hInst, _T("WSACleanup"));
    pWSAGetLastError = (void *)GetProcAddress(hInst, _T("WSAGetLastError"));
    psocket = (void *)GetProcAddress(hInst, _T("socket"));
    pioctlsocket = (void *)GetProcAddress(hInst, _T("ioctlsocket"));
    psetsockopt = (void *)GetProcAddress(hInst, _T("setsockopt"));
    precvfrom = (void *)GetProcAddress(hInst, _T("recvfrom"));
    psendto = (void *)GetProcAddress(hInst, _T("sendto"));
    pclosesocket = (void *)GetProcAddress(hInst, _T("closesocket"));
    pgethostname = (void *)GetProcAddress(hInst, _T("gethostname"));
    pgethostbyname = (void *)GetProcAddress(hInst, _T("gethostbyname"));
    pgethostbyaddr = (void *)GetProcAddress(hInst, _T("gethostbyaddr"));
    pgetsockname = (void *)GetProcAddress(hInst, _T("getsockname"));
