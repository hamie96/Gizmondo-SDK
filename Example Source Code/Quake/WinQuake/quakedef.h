...
//Dan East:
//The following definitions trigger the use of various fixed point optimized routines.
//These should be used for target hardware that does not support floating point math.
