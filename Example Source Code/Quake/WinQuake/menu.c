...
{
	Draw_TransPic (x + ((vid.width - min_vid_width/*320*/)>>1), y, pic);
}

void M_DrawPic (int x, int y, qpic_t *pic)
{
	Draw_Pic (x + ((vid.width - min_vid_width/*320*/)>>1), y, pic);
}
...
{
	Draw_TransPicTranslate (x + ((vid.width - min_vid_width/*320*/)>>1), y, pic, translationTable);
}
...
void M_Main_Draw (void)
{
	...
	qpic_t	*p;
/*
//	M_DrawTransPic (0, 4, Draw_CachePic ("gfx/qplaque.lmp") );
	p = Draw_CachePic ("gfx/ttl_main.lmp");
	M_DrawPic ( (min_vid_width-p->width)/2, 4, p);
	M_DrawTransPic (18, 32, Draw_CachePic ("gfx/mainmenu.lmp") );	//56

	f = (int)(host_time * 10)%6;
			//38
	M_DrawTransPic (0, 32 + m_main_cursor * 20,Draw_CachePic( va("gfx/menudot%i.lmp", f+1 ) ) );
*/
...
void M_SinglePlayer_Draw (void)
{
	...
	M_DrawPic ( (min_vid_width/*320*/-p->width)/2, 4, p);
...
void M_Load_Draw (void)
{
	...
	M_DrawPic ( (/*320*/min_vid_width-p->width)/2, 4, p);
...
void M_AdjustSliders (int dir)
{
	...
	case 4:	// gamma
		...
		break;
	case 5:	// mouse speed
		sensitivity.value += (float)(dir * 0.5);
	...
	case 6:	// music volume
#ifdef _WIN32
		bgmvolume.value += (float)(dir * 1.0);
#else
		bgmvolume.value += (float)(dir * 0.1);
#endif
	...
	case 13:	// _windowed_mouse
		Cvar_SetValue ("_windowed_mouse", (float)!_windowed_mouse.value);
		break;
#endif
	}
}
...
void M_Options_Draw (void)
{
	//Dan East: modified menu width to fit a narrow screen
	float		r;
	qpic_t	*p;
	...
	M_Print (16, 40, "       Console");
	M_Print (16, 48, "      Defaults");

	M_Print (16, 56, "   Screen size");
	r = (scr_viewsize.value - 30) / (120 - 30);
	M_DrawSlider (148/*220*/, 56, r);

	M_Print (16, 64, "    Brightness");
	r = (float)((1.0 - v_gamma.value) / 0.5);
	M_DrawSlider (148/*220*/, 64, r);

	M_Print (16, 72, "   Mouse Speed");
	r = (sensitivity.value - 1)/10;
	M_DrawSlider (148/*220*/, 72, r);

	M_Print (16, 80, "    CD Volume");
	r = bgmvolume.value;
	M_DrawSlider (148/*220*/, 80, r);

	M_Print (16, 88, "  Sound Volume");
	r = volume.value;
	M_DrawSlider (148/*220*/, 88, r);

	M_Print (16, 96,  "    Always Run");
	M_DrawCheckbox (140/*220*/, 96, cl_forwardspeed.value > 200);

	M_Print (16, 104, "  Invert Mouse");
	M_DrawCheckbox (140/*220*/, 104, m_pitch.value < 0);

	M_Print (16, 112, "    Lookspring");
	M_DrawCheckbox (140/*220*/, 112, (int)lookspring.value);

	M_Print (16, 120, "    Lookstrafe");
	M_DrawCheckbox (140/*220*/, 120, (int)lookstrafe.value);

	if (vid_menudrawfn)
		M_Print (16, 128, "         Video");

#ifdef _WIN32
	if (modestate == MS_WINDOWED)
	{
		M_Print (16, 136, "     Use Mouse");
		M_DrawCheckbox (148/*220*/, 136, (int)_windowed_mouse.value);
	}
#endif

// cursor
	M_DrawCharacter (132/*220*/, 32 + options_cursor*8, 12+((int)(realtime*4)&1));
}
...
void M_Quit_Draw (void)
{
	...
	M_PrintWhite (16, 20,  "Programming        Art \n");
	M_Print (16, 28,  " John Carmack       Adrian Carmack\n");
	M_Print (16, 36,  " Michael Abrash     Kevin Cloud\n");
	M_Print (16, 44,  " John Cash          Paul Steed\n");
	M_Print (16, 52,  " Dave 'Zoid' Kirsch\n");
	M_Print (16, 60,  " PocketPC: Dan East\n");
...
void M_NetStart_Change (int dir)
{
	...
	case 2:
		Cvar_SetValue ("coop", (float)(coop.value ? 0 : 1));
		break;
	...
	case 3:
		...
		if (teamplay.value > count)
			...
			Cvar_SetValue ("teamplay", (float)count);
		break;
