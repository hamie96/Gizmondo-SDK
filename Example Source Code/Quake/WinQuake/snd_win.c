...
//Dan East:
//This file has been modifed to remove all DirectX Sound calls.
...
#define	WAV_BUFFER_SIZE			0x0800	//0x0400	//Dan:
...
qboolean SNDDMA_InitWav (void)
{
					...
					0, 0L, CALLBACK_NULL)) != MMSYSERR_NOERROR)
	{
		...
		if (MessageBox (NULL,
					    ...
					    _T("Select Retry to try to start sound again or Cancel to run Quake with no sound."),
