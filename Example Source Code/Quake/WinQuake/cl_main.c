...
// clear other arrays	
	memset (cl_efragsFPM, 0, sizeof(cl_efragsFPM));
	memset (cl_entitiesFPM, 0, sizeof(cl_entitiesFPM));
	memset (cl_dlightsFPM, 0, sizeof(cl_dlightsFPM));
	memset (cl_lightstyle, 0, sizeof(cl_lightstyle));
	memset (cl_temp_entitiesFPM, 0, sizeof(cl_temp_entitiesFPM));
	memset (cl_beamsFPM, 0, sizeof(cl_beamsFPM));
