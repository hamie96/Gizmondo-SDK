...
#define ATARI_TITLE  "Atari 800 Emulator, Version 2.0.1GP1.2"
...
extern char atari_menu_filename[FILENAME_MAX];
extern char atari_uimenu_filename[FILENAME_MAX];
extern char atari_clockcommand_filename[FILENAME_MAX];
...
#define AKEY_RSHIFT -10
#define AKEY_FASTFORWARDON -11
#define AKEY_FASTFORWARDOFF -12
#define AKEY_FASTFORWARDTOGGLE -13
#define AKEY_VOLUMEUP -14
#define AKEY_VOLUMEDOWN -15
...
#define AFILE_ZIP        15 // only SIO for now
