...
#define SAMP_MAX (127<<7)			/* then set signed 8-bit clipping ranges */
#define SAMP_MIN (-128<<7)
#define SAMP_MID 0
#else
#define SAMP_MAX (255<<7)			/* else set unsigned 8-bit clip ranges */
#define SAMP_MIN (0<<7)
#define SAMP_MID (128<<7)
#endif

	void Pokey_sound_init(uint32, uint16,uint8);
...
extern uint16 snd_playback_freq;
